...
def _subset_fingerprint_generator_data(fingerprint_generator, klifs_residue_ids):
    """
    Subset the unnormalized fingerprints included in the fingerprint generator.
    ...
    fingerprint_generator_data_subset = {}
